...
jurnal_md_articles = open('jurnal_md_articles.txt', 'w', encoding='utf-8')
moldova1_articles = open('moldova1_articles.txt', 'w', encoding='utf-8')
realitatea_articles = open('realitatea_articles.txt', 'w', encoding='utf-8')
cotidianul_articles = open('cotidianul_articles.txt', 'w', encoding='utf-8')
vocea_basarabiei_articles = open('vocea_basarabiei_articles.txt', 'w', encoding='utf-8')
zugo_articles = open('zugo_articles.txt', 'w', encoding='utf-8')
esp_articles = open('esp_articles.txt', 'w', encoding='utf-8')
expresul_articles = open('expresul_articles.txt', 'w', encoding='utf-8')
nordnews_articles = open('nordnews_articles.txt', 'w', encoding='utf-8')
unica_articles = open('unica_articles.txt', 'w', encoding='utf-8')
